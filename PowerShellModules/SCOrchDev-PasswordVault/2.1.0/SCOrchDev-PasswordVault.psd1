...
ModuleList = @('SCOrchDev-PasswordVault')

# List of all files packaged with this module
FileList = @('SCOrchDev-PasswordVault.psd1', 'SCOrchDev-PasswordVault.psm1', 'SCOrchDev-PasswordVault.tests.ps1', 'LICENSE', 'README.md')
