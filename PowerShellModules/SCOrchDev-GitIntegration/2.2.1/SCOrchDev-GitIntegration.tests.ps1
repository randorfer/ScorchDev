...
$manifestPath = "$here\SCOrchDev-GitIntegration.psd1"
Import-Module $manifestPath -Force

Describe -Tags 'VersionChecks' 'SCOrchDev-F5 GitIntegration' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-GitIntegration
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be 'd3492bd8-9bac-4605-a21b-539589a94b3b'
    }
