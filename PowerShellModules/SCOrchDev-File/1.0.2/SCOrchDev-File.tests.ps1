...
Describe -Tags 'VersionChecks' 'SCOrchDev-File manifest' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-File
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be '9f560bb6-6633-4efe-87d9-a12fcf1c81ff'
    }
...
Describe 'Style rules' {
    $SCOrchDevUtilityRoot = (Get-Module SCOrchDev-File).ModuleBase
